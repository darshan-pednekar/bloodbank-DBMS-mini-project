				...
				<div class="card">
					...
					<div class="card-body">
					   <form action="file/updateprofile.php" method="post">
						...
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Receiver Age</label>
						<input type="number" name="rage" value="<?php echo $row['rage']; ?>" class="form-control mb-3">
						<label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Receiver Weight</label>
						<input type="number" name="rwght" value="<?php echo $row['rwght']; ?>" class="form-control mb-3">
